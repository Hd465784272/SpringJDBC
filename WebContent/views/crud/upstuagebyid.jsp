...
<body>
	...
	<div class="contentmain">
		<div class="banner"
			...
			<div>
				<h1 style="font-size: 1.1em; font-family: cursive; color: black;">Update
					Age Of Stu By ID Demo</h1>
				<form action="/SpringJDBC/update" method="post">
					id:<input name="id" type="text"> age:<input name="age"
						type="text"> <input type="submit" value="Update">
				</form>
			</div>
		</div>
	</div>
