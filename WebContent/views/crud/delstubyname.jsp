...
<body>
	...
	<div class="contentmain">
		<div class="banner"
			...
			<div>
				<h1 style="font-size: 1.1em;font-family: cursive;color: black;">Delete By ID Demo</h1>
				<form action="/SpringJDBC/deletebyid" method="post">
					id:<input name="id" type="text"> <input type="submit"
						value="Delete">
				</form>
			</div>
		</div>
